...
class UNI():
    def __init__(self, args):
        self.args = args
        print(self.args)
        self.use_audio = (args["uni"]["modal"] == "a") # False: use_video
        print(f"Training the Audio: {self.use_audio} / Video: {not(self.use_audio)}")
        ...
        while True:
            ...
            with tqdm(dataloader['train']) as td:
                for batch_data in td:
                    ...
                    # forward
                    if self.use_audio:
                        outputs = model(None, audio, None)
                    else:
                        outputs = model(None, None, vision)
                    # compute loss
