...
def main():
    ...
    parser.add_argument('--exp-name', default='sims-train', help='Experiment name')
    ...
    if args.config:
        ...
        config_path = work_dir / "MMSA" / "config" / "regression" / "deepmlf" / "sims" / "base_best.json"
    ...
    cmd = [
        ...
        "-c", str(config_path),
        "--res-save-dir", "/leonardo/home/userexternal/nxiros00/Deepmlf/results/SIMS",
        "--model-save-dir", "/leonardo/home/userexternal/nxiros00/Deepmlf/checkpoints/SIMS/model",
        "-n", "2"
    ]
